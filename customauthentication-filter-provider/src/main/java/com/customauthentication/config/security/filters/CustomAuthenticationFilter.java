package com.customauthentication.config.security.filters;

import com.customauthentication.config.security.authentication.CustomAuthentication;
import com.customauthentication.config.security.managers.CustomAuthenticationManager;
...
public class CustomAuthenticationFilter extends OncePerRequestFilter {
    ...
    /*
    AuthenticationFilter --> AuthenticationManager --> AuthenticationProvider --> UserDetailsService and PasswordEncoder
     */
